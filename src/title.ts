...
export const BUILD_HOURS = import.meta.env.VITE_BUILD_HOURS ?? '~2';
...
export function titleHtml(): string {
  ...
  <div class="title">
    ...
    <aside class="apply">
      ...
      <p class="a">This one: <strong>${BUILD_HOURS} hours</strong> from a one-page brief to this deployed build, using Claude Code as the primary dev tool. The <a href="${REPO}/commits/main" target="_blank" rel="noopener">commit log</a> is the timeline.</p>
      <dl>
        <dt>Who</dt>
